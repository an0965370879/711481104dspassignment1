...
**觀察與討論：**
* **振幅：** * 隨著輸入訊號頻率的增加，濾波後訊號的振幅明顯**衰減**。這符合 RC 濾波器作為低通濾波器的特性。
  * 請填寫你的具體觀察數據。例如：對於 100 Hz 輸入訊號，振幅衰減較小；對於 3000 Hz 輸入訊號，振幅衰減非常顯著。
* **相位：**
  * 濾波後的訊號與原始訊號相比，**產生了相位延遲**。請填寫你的具體觀察。例如：濾波後波形向右平移（延遲）。
  * 訊號頻率越高，相位延遲越明顯。這也符合濾波器在不同頻率下的相位響應特性。
